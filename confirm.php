...
<div id="exp" class="cd-section">
    ...
    <?php
    if (isSet($_GET)) {
        $_SESSION["data"]["content"] = $_GET["content"];
        $_SESSION["data"]["description"] = $_GET["description"];
        $_SESSION["data"]["type"] = $_GET["type"];
    }
    ?>
    <section>
        <h2 class="margin">Bevestig</h2>
        <form method="post" action="index.php?confirmed">
            <br>
            <div class="chair"><label for="number">Poef nummer</label>
                ...
                <input type="submit" id="pubload" value="Upload!" onclick="pubLoad();">
